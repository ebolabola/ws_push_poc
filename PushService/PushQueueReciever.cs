...
{
    public class QueueRiceReciever
    {
        private PushMessageType _pushMessageType;
        private IConnectionManager _connectionManager;
        private RabbitQueue _queue;

        public QueueRiceReciever(string connectionString, int instanceKey, IConnectionManager connectionManager, PushMessageType pushMessageType)
        {
